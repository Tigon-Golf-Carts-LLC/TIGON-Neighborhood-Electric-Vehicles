...
const getGoogleMapsEmbedUrl = (townName: string, townType: string): string => {
  ...
  // Return specific map or fallback to generic Ocean County embed for smaller towns
...
export default function TownPage({ townName, townType }: TownPageProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4 bg-gradient-to-r from-theme-primary to-blue-700 text-white bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(14, 46, 85, 0.8), rgba(29, 78, 216, 0.8)), url('https://bucksgolfcarts.com/attached_assets/Ocean County Golf Carts New Jersey 3_1753197335727.jpeg')"}}>
