  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <section className="relative py-12 px-4 bg-white bg-cover bg-center bg-no-repeat" style={{backgroundImage: "linear-gradient(rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.9)), url('/attached_assets/TIGON - Medium Speed Vehicles 2_1763150117019.jpeg')"}}>
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Six-passenger extreme terrain model with maximum off-road capability and adventure features. The ultimate off-road medium speed vehicle for group adventures.
                </p>
                
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-theme-primary">Extreme Terrain</div>
                    <div className="text-gray-900">Maximum Capability</div>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg border">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-theme-primary">6-Passenger</div>
                    <div className="text-gray-900">Adventure Group</div>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-theme-primary">Adventure Ready</div>
                    <div className="text-gray-900">Ultimate Off-Road</div>
                  </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D6 Max XT6 Maximum Off-Road Medium Speed Vehicle"
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8 text-gray-900">Ultimate Adventure</h2>
