            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">Extreme Terrain</div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">6-Passenger</div>
                    <div className="text-gray-900">Adventure Group</div>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">Adventure Ready</div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D6 Max XT6 Maximum Off-Road Golf Cart"
        ...
        <section className="py-8 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <div className="text-3xl font-bold text-green-600 mb-2">$19,995</div>
