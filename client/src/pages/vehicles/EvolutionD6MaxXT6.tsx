...
import vehicleImage from "@assets/EVOLUTIOND6MAXXT6_1751893159005_1753135437836.jpg";

export default function EvolutionD6MaxXT6() {
  return (
    <>
      <SEOHead 
        title="Max XT6"
        ...
        keywords="EVOLUTION D6 Max XT6, extreme terrain neighborhood electric vehicle, 6-passenger off-road, maximum capability, adventure features, EVOLUTION dealer nationwide PA"
        canonicalUrl="https://tigonnev.com/vehicles/evolution-d6-max-xt6"
        ...
        <nav className="py-4 px-4 bg-white border-b border-gray-200">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>→</span>
              <span className="drop-shadow-lg">D6 Max XT6</span>
            </div>
          </div>
        </nav>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 text-white">
                ...
                <p className="text-xl drop-shadow-md mb-8 leading-relaxed">
                  Six-passenger extreme terrain model with maximum off-road capability and adventure features. The ultimate off-road neighborhood electric vehicle for group adventures.
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    ...
                    <div className="drop-shadow-lg">Maximum Capability</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                  ...
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">6-Passenger</div>
                    <div className="drop-shadow-lg">Adventure Group</div>
                  </div>
                  <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg">
                    <div className="font-semibold text-theme-orange">Adventure Ready</div>
                    <div className="drop-shadow-lg">Ultimate Off-Road</div>
                  </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="relative">
                  <img 
                    src={vehicleImage} 
                    alt="EVOLUTION D6 Max XT6 Maximum Off-Road Neighborhood Electric Vehicle"
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8 drop-shadow-lg">Ultimate Adventure</h2>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Maximum off-road capability with enhanced suspension, tires, and drivetrain for the most challenging terrain.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Spacious seating for six adventurers with rugged comfort and safety features for group exploration.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Ultimate adventure features including enhanced ground clearance, protection systems, and utility options.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <Award className="w-6 h-6 text-theme-primary mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Maximum Capability</h3>
                      <p className="text-gray-600">Industry-leading off-road capability with maximum power, range, and durability for extreme adventures.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact TIGON Neighborhood Electric Vehicles today for your EVOLUTION D6 Max XT6.
            </p>
