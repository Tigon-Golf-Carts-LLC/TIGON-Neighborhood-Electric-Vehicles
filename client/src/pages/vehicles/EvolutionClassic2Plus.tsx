              ...
              <div className="order-2 lg:order-1">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">Classic Design</div>
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">Compact</div>
                    <div className="text-gray-900">Easy Maneuver</div>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg border">
                    <div className="font-semibold text-green-600">Entry Level</div>
        ...
        <section className="py-8 px-4 bg-green-50">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div>
                <div className="text-3xl font-bold text-green-600 mb-2">$9,995</div>
        ...
        <section className="py-16 px-4 bg-gray-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact Ocean County Golf Carts today for your EVOLUTION Classic 2 Plus.
            </p>
